...
void ScaleConverter::init(uint32_t srcWidth, uint32_t srcHeight, uint32_t srcPixFmt, 
...
std::shared_ptr<Memory> ScaleConverter::scaleConvertFrame (std::shared_ptr<Memory> srcBuf, 
